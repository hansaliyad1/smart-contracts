...
const config    = require('../../bin/config/config'); // Import database configuration
                    ...
                    if (err) {
                        ...
                        if (!user) {
                            ...
                            if (!validPassword) {
                                ...
                                res.json({ success: true, message: 'Keys Created. Please save your keys. We don\'t keep records of your keys. If lost, we won\'t be able retrieve txids created from this keys', keys: key_pair })
                            }
                        }
                    }
                });
